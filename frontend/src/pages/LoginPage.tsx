...
import { Leaf, ArrowLeft, Phone, Lock, Eye, EyeOff } from 'lucide-react';
...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin, loggedInUser }) => {
    ...
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-xs text-dark-neutral/60">
          Masukkan nomor telepon dan kata sandi Anda untuk melanjutkan.
        </p>
      </div>
